...
#' # stopCluster(cl)
#'
#' @import remotes parallel devtools plotly rJava mice BiocManager MatchIt curl reticulate kableExtra plyr dplyr edgeR epiDisplay rsq MASS Biocomb caret dplyr pROC ggplot2 DMwR doParallel Boruta spFSR varSelRF stringr psych C50 randomForest doSNOW foreach data.table ROSE deepnet gridExtra stargazer gplots My.stepwise snow sva Biobase calibrate ggrepel networkD3 VennDiagram RSNNS kernlab car PairedData profileR classInt kernlab xgboost keras tidyverse cutpointr tibble tidyr rpart party mgcv GDCRNATools rJava cutpointr imputeMissings visdat naniar stringr doSNOW R.utils TCGAbiolinks GDCRNATools kableExtra VIM mice MatchIt XML rmarkdown xtable ComplexHeatmap circlize BiocStyle magick BiocCheck cluster tidyselect ellipsis
#'
#' @export
