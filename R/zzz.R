.onAttach <- function(libname, pkgname) {
  ...
  # Normalne paczki
  packages <- c("remotes","devtools", "plyr","dplyr","edgeR","epiDisplay","rsq","MASS","Biocomb","caret","dplyr", "roxygen2", "plotly", "rJava", "mice", "MatchIt", "kableExtra", "reticulate",
  ...
  suppressWarnings(suppressMessages(BiocManager::install(setdiff(packages, rownames(installed.packages())), ask = F)))  }
