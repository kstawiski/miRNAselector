...
pd = paired(as.numeric(acc[1:3,paste0(metody[i],"_train_Accuracy")]),as.numeric(acc[1:5,paste0(metody[i],"_test_Accuracy")]))
colnames(pd) = c("Train Acc","Test Acc")
plot2 = ks.profileplot(pd, Method.id = acc$method[1:5], standardize = F)
pd = paired(as.numeric(acc[1:3,paste0(metody[i],"_train_Accuracy")]),as.numeric(acc[1:5,paste0(metody[i],"_valid_Accuracy")]))
colnames(pd) = c("Train Acc","Valid Acc")
plot3 = ks.profileplot(pd, Method.id = acc$method[1:5], standardize = F)
pd = paired(as.numeric(acc[1:3,paste0(metody[i],"_test_Accuracy")]),as.numeric(acc[1:5,paste0(metody[i],"_valid_Accuracy")]))
colnames(pd) = c("Test Acc","Valid Acc")
plot4 = ks.profileplot(pd, Method.id = acc$method[1:5], standardize = F)
