...
orginal_TCGA_data = fread("tissue_miRNA_counts.csv")
...
ks.benchmark(search_iters = 5, # 5 random hyperparameter sets will be checked; 5 is set here for speed purposes.. for real projects use more
  algorithms = c("mlp", "mlpML", "svmRadial", "svmLinear", "rf", "C5.0", "rpart", "rpart2", "ctree"), # default set of methods, note that logistic regression (glm) is always included
