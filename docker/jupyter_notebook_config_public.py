...
#c.ContentsManager.hide_globs = ['__pycache__', '*.pyc', '*.pyo', '.DS_Store', '*.so', '*.dylib', '*~', 'miRNAselector']
...
c.ContentsManager.untitled_file = 'miRNAselector test file'

## The base name used when creating untitled notebooks.
c.ContentsManager.untitled_notebook = 'miRNAselector test notebook'
